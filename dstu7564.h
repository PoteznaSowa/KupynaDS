 ...
 * @return контекст ДСТУ 7564
 */
Dstu7564Ctx *dstu7564_alloc_user_sbox(const ByteArray *sbox);
 ...
 * @return код помилки
 */
int dstu7564_init(Dstu7564Ctx *ctx, size_t hash_len);
 ...
 * @return код помилки
 */
int dstu7564_final(Dstu7564Ctx *ctx, ByteArray **hash);
