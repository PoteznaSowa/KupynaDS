 ...
 * @return код помилки
 */
int crypto_cache_add_dstu4145_pb(const int *f, size_t f_len, int a, const ByteArray *b,
		const ByteArray *n,
 ...
 * @return код помилки
 */
int crypto_cache_add_dstu4145_onb(const int m, int a, const ByteArray *b, const ByteArray *n,
		const ByteArray *px, const ByteArray *py, OptLevelId opt_level);
