 ...
 * @return контекст ДСТУ 7624
 */
Dstu7624Ctx *dstu7624_alloc_user_sbox(ByteArray *sbox);
 ...
 * @return код помилки
 */
int dstu7624_init_cmac(Dstu7624Ctx *ctx, const ByteArray *key, const size_t block_size,
		const size_t q);
 ...
 * @return код помилки
 */
int dstu7624_init_gmac(Dstu7624Ctx *ctx, const ByteArray *key, const size_t block_size,
		const size_t q);
 ...
 * @return код помилки
 */
int dstu7624_init_ccm(Dstu7624Ctx *ctx, const ByteArray *key, const ByteArray *iv, const size_t q,
		uint64_t n_max);
 ...
 * @return код помилки
 */
int dstu7624_encrypt_mac(Dstu7624Ctx *ctx, const ByteArray *auth_data, const ByteArray *data,
 ...
 * @return код помилки
 */
int dstu7624_decrypt_mac(Dstu7624Ctx *ctx, const ByteArray *auth_data,
 ...
 * @return код помилки
 */
int dstu7624_encrypt(Dstu7624Ctx *ctx, const ByteArray *data, ByteArray **encrypted_data);
 ...
 * @return код помилки
 */
int dstu7624_decrypt(Dstu7624Ctx *ctx, const ByteArray *encrypted_data, ByteArray **data);
