 ...
 * @return контекст ДСТУ 4145
 */
Dstu4145Ctx *dstu4145_alloc_pb(const int *f, size_t f_len, int a, const ByteArray *b,
 ...
 * @return контекст ДСТУ 4145
 */
Dstu4145Ctx *dstu4145_alloc_onb(const int m, int a, const ByteArray *b, const ByteArray *n,
 ...
 * @return код помилки
 */
int dstu4145_get_params(const Dstu4145Ctx *ctx, int **f, size_t *f_len, int *a, ByteArray **b,
 ...
 * @return код помилки
 */
int dstu4145_compress_pubkey(const Dstu4145Ctx *ctx, const ByteArray *qx, const ByteArray *qy,
		ByteArray **q);
 ...
 * @return код помилки
 */
int dstu4145_decompress_pubkey(const Dstu4145Ctx *ctx, const ByteArray *q, ByteArray **qx,
		ByteArray **qy);
 ...
 */
int dstu4145_verify(const Dstu4145Ctx *ctx, const ByteArray *hash, const ByteArray *r,
		const ByteArray *s);
